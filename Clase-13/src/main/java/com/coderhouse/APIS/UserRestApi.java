...
public class UserRestApi implements UserRestInterface {
	...
	private final String BASE_URL = "https://6785a89ef80b78923aa4228a.mockapi.io/users";
	...
	public List<User> getAllUsers() {
		...
		try {
			...
			List<User> usuarios = restTemplate.exchange(BASE_URL, HttpMethod.GET, null, List.class).getBody();
	...
	public User updateUser(User user) {
		...
		try {
			...
			String url = BASE_URL + "/" + user.getIdUser();
